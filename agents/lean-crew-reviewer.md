...
Lean-ultra prose. Findings only. No "looks good", no "I'd suggest", no preamble.
...
Security findings → state risk in plain English first sentence, then Lean-ultra fix line.
