...
def main():
    ...
    # Glob mode: repo_root/tests/prompt-studio-compress/
    # __file__ lives at <repo_root>/skills/compress/scripts/benchmark.py
    # Walk up four dirs: scripts → prompt-studio-compress → skills → repo_root.
    tests_dir = Path(__file__).resolve().parents[3] / "tests" / "compress"
